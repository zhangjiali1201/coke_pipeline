...
void down1(int id)
{
	if (elbow1 > -30 && movez >= 0.15&&movex<0.3)
		elbow1 -= 0.4;
	glutPostRedisplay();
	glutTimerFunc(10, down1, 11);
}//第一台机械臂下降

void up1(int id)
{
	if (elbow1<0 && movez <= 0.15&&movex<0.3)
		elbow1 = elbow1 + 0.2;
	glutPostRedisplay();
	glutTimerFunc(10, up1, 12);
}//第一台机械臂回升

void down2(int id)
{

	if (elbow2> -30 && movez <= 0.1&&movex>0.3)
		elbow2 = elbow2 - 0.4;
	glutPostRedisplay();
	glutTimerFunc(10, down2, 21);
}//第二台机械臂下降

void up2(int id)
{
	if (elbow2<0 && movex>0.3&&movez>0.1)
		elbow2 = elbow2 + 0.2;
	glutPostRedisplay();
	glutTimerFunc(10, up2, 22);
}//第二台机械臂回升
...
void keyboard(unsigned char key, int x, int y)
{
	...
	{ {
			...
			glutTimerFunc(9500, move3, 3);//13500
			glutTimerFunc(13500, move4, 4);//18000
			glutTimerFunc(1000, down1, 11);//1600
			glutTimerFunc(3600, up1, 12);
			glutTimerFunc(11000, down2, 21);//16000
			glutTimerFunc(13500, up2, 22);//18500
		}
	break;
	}
	default:
